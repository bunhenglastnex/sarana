  ...
  return (
    <section className="flex items-center gap-space-xs mb-space-md">
      ...
      <button
        ...
        className="w-11 h-11 flex-shrink-0 flex items-center justify-center rounded-full bg-surface-container-lowest text-on-surface shadow-sm border border-surface-container/60 hover:bg-surface-container active:scale-95 transition-all"
      >
