...
function seedDatabase(PDO $pdo): void {
    ...
    $pdo->exec("INSERT IGNORE INTO orders 
        (id, restaurant_id, order_number, user_id, customer_name, customer_phone, fulfillment_type, delivery_address, delivery_lat, delivery_lng, delivery_fee, food_amount, total_amount, amount_khr, payment_method, payment_status, payment_proof_url, payment_txn_ref, status, delivery_staff_id, notes, created_at) 
        VALUES
        (1, 1, '#1024', 103, 'John Smith', '+1 (555) 382-9012', 'delivery', '742 Evergreen Terr, Apt 3B', 13.35950000, 103.96120000, 0.00, 34.50, 34.50, 138000, 'cod', 'pending', NULL, 'COD-PENDING-1', 'ready_for_delivery', 2, 'Door code #4910. Ring bell twice, leave on vestibule shelf if no answer.', DATE_SUB(NOW(), INTERVAL 10 MINUTE)),
        (1026, 1, '#1026', 101, 'David Chen', '+1 (555) 234-9912', 'delivery', '520 N Michigan Ave, Apt 14F', 13.35700000, 103.95900000, 0.00, 29.50, 29.50, 118000, 'khqr', 'verified', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTW_nSl8ar5rgvxpgYec8c80SO7FC8JTpLhfNGATJtMEA&s=10', 'KHQR-889102', 'pending', NULL, 'Ring buzzer 14F on arrival', NOW()),
        (1025, 1, '#1025', 102, 'Clara Oswald', '+1 (555) 604-3382', 'pickup', NULL, NULL, NULL, 0.00, 15.00, 15.00, 60000, 'counter_cash', 'pending', NULL, NULL, 'pending', NULL, 'Dressing on Side', NOW()),
        (1027, 2, '#1027', 107, 'Elena Vance', '+1 (555) 301-4490', 'delivery', '12 Riverside Promenade', 13.34520000, 103.94650000, 0.00, 62.00, 62.00, 248000, 'khqr', 'verified', NULL, 'KHQR-889127', 'on_the_way', 3, 'Crossing South Bridge', DATE_SUB(NOW(), INTERVAL 18 MINUTE)),
        (1023, 2, '#1023', 104, 'Sophia Lin', '+1 (555) 492-1084', 'pickup', NULL, NULL, NULL, 0.00, 28.00, 28.00, 112000, 'khqr', 'verified', 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=500&auto=format&fit=crop', 'APPLE-PAY-4401', 'ready_for_pickup', NULL, 'House BBQ Sauce', DATE_SUB(NOW(), INTERVAL 19 MINUTE)),
        (1022, 1, '#1022', 105, 'Marcus Vance', '+1 (555) 891-2240', 'delivery', '128 W Huron St, Suite 500', 13.35500000, 103.95200000, 3.00, 38.20, 41.20, 164800, 'khqr', 'verified', 'https://images.unsplash.com/photo-1580519542036-c47de6196ba5?w=500&auto=format&fit=crop', 'CARD-889105', 'on_the_way', 2, 'Leave at front desk', DATE_SUB(NOW(), INTERVAL 32 MINUTE)),
        (1021, 2, '#1021', 106, 'Sophia Meng', '+1 (555) 773-4019', 'delivery', '88 Belmont St, Suite 12', 13.35820000, 103.95620000, 0.00, 69.00, 69.00, 276000, 'cod', 'pending', NULL, 'COD-889106', 'on_the_way', 4, 'At building entrance', DATE_SUB(NOW(), INTERVAL 8 MINUTE)),
        (1019, 1, '#1019', 107, 'Elena Vance', '+1 (555) 301-4490', 'delivery', '333 N Dearborn St', 13.35000000, 103.95000000, 0.00, 38.50, 38.50, 154000, 'khqr', 'refunded', NULL, 'KHQR-REFUND-19', 'cancelled', NULL, 'Customer requested cancellation', DATE_SUB(NOW(), INTERVAL 72 MINUTE))");
